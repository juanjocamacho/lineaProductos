...
class AmigoTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let amigo1 = Amigo(nombre: "Irene", foto: UIImage(named:"Amigo1")!, gAfinidad: 5)
        let amigo2 = Amigo(nombre: "Ali", foto: UIImage(named:"Amigo2")!, gAfinidad: 0)
        let amigo3 = Amigo(nombre: "Rup", foto: UIImage(named:"Amigo3")!, gAfinidad: 5)
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // OVERRIDE: THIS IS COMPLETE #warning Incomplete implementation, return the number of rows
        return amigos.count
    }
    /**override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.evaluacion.gradoAfinidad = 2
